...
def get_audio_with_fadeout(file_path):
    audio_file = AudioSegment.from_file(file_path)
    return audio_file.fade_out(1000)
...
def main():
    ...
    #BGM
    audio1 = get_audio_with_fadeout("airadio-bgm.mp3")
    audio2 = get_audio_with_fadeout("airadio-corner-bgm.mp3") - 10
    print("BGMの処理完了")
